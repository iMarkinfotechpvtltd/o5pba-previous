			...
			if (mysql_num_rows($result) < 1 ){
				...
				while ($this->database->next_record()){	
					...
					print "<td align='left' style='vertical-align:middle;' >"."<IMG SRC='../images/spacer.gif' style='vertical-align:middle;'  WIDTH=20 HEIGHT=8>".
						  "<a href='http://".$this->database->f('url')."'>".
						  "<img src='../images/sponsors/".$this->database->f('logo')."' alt='LOGO' style='vertical-align:middle;' border=0 width=".$result[0]." height=".$result[1].">".
					 	 "</a>"."</td>";
