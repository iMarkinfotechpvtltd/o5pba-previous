...
class perfect{
	...
	function form($validate=false){
		...
		$this->form->start();
                ...
                <table border="0" cellpadding="2" cellspacing="0" width=300>
                  ...
                  <tr>
                      <td class=dark style='vertical-align:middle; text-align:right;'>League/Event</td>
                      <td class=light>
                      <?
	...
	function plist(){
		...
		$this->db->query('select * from perfect order by date;');
		echo '<h4>Edit Perfect Games</h4>';
		echo '<table width=600 cellspacing=0 cellpadding=2>';
		echo '<tr><th width=110 colspan=2>Name</th><th width=110>Date</th><th width=135>Bowling Centre</th><th width=245 colspan=2>League/Event</th></tr>';
