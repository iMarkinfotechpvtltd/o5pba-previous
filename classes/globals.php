...
for ( $i = ($hidhdyear-8); $i <=($hidhdyear+2); $i++ ) {

array_push($years,array("label"=>$i,"value"=>$i));
}

$times=array(array("value"=>"","label"=>"Time"),
array("label"=>"00:00","value"=>"0"),
array("label"=>"01:00","value"=>"1"),
array("label"=>"02:00","value"=>"2"),
array("label"=>"03:00","value"=>"3"));
?>