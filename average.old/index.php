...
<P ALIGN=right>Name:</P></TD><TD><P><? echo $db->f('first').' '.$db->f('last'); ?> </P></TD></TR><TR><TD WIDTH="33%" ALIGN=right>

<P ALIGN=right>Membership Number:</P></TD><TD><P> <? echo $db->f('sex'); ?> </P></TD></TR><TR><TD WIDTH="33%" ALIGN=right>

<P ALIGN=right>League:</P></TD><TD><P> <? echo $db->f('category'); ?> </P></TD></TR><TR><TD WIDTH="33%" ALIGN=right>

<P ALIGN=right>Membership Number:</P></TD><TD><P> <? echo $db->f('memberid'); ?> </P></TD></TR><TR><TD WIDTH="33%" ALIGN=right>

<P ALIGN=right>League:</P></TD><TD><P> <? echo $db->f('league'); ?> </P></TD></TR><TR><TD WIDTH="33%" ALIGN=right>

<P ALIGN=right>Association:</P></TD><TD><P> <? echo $db->f('association'); ?></P></TD></tr>
...
<td width=75><P ALIGN=right class=light><? echo $db->f('games') ; ?>&nbsp;&nbsp;&nbsp;&nbsp; </td>
...
<td width=75><P ALIGN=right class=light><? echo $db->f('average') ; ?>&nbsp;&nbsp;&nbsp;&nbsp;</td>
