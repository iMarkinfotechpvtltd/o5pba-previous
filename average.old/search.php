...
<TABLE BORDER=0 WIDTH="600">
   <TR>
      ...
      <TD>
         <font size="2"><CENTER><B>League</B></CENTER></font>
      </TD>
      <TD>
         <font size="2"><CENTER><B>Games</B></CENTER></font>
      </TD>
      <TD>
         <font size="2"><CENTER><B>Average</B></CENTER></font>
      </TD>
</B></CENTER></TR>
<? 
while ($db->next_record()){
...
<TR>
      ...
      <TD>
         <CENTER><? echo $db->f('league'); ?></CENTER>
      </TD>
      <TD>
...
for ($i=$current; $i>$oldest-1; $i--){
	...
	echo '<td width=50 class=dark><P ALIGN=center>'.substr(($i-1),-2,2).'-'.substr(($i),-2,2).'</td>';
...
for ($i=$current; $i>$oldest-1; $i--){
	...
	echo '<td width=50><P ALIGN=right class=light>'.$y[$i]['games'].'&nbsp;</td>';
...
for ($i=$current; $i>$oldest-1; $i--){
	...
	echo '<td width=50><P ALIGN=right class=light>'.$y[$i]['average'].'&nbsp;</td>';
...
<td><P ALIGN=right class=dark>Ontario Placing</td>

<?

for ($i=$current; $i>$oldest-1; $i--){

	echo '<td width=50><P ALIGN=right class=light>'.$y[$i]['oplacing'].'&nbsp;</td>';
...
<td><P ALIGN=right class=dark>Association Placing</td>

<?

for ($i=$current; $i>$oldest-1; $i--){

	echo '<td width=50><P ALIGN=right class=light>'.$y[$i]['aplacing'].'&nbsp;</td>';
