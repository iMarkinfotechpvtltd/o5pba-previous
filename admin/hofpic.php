...
if ($_POST['action']=='submit'){
	...
	$upload_class->upload_dir = $htdocsdir."hallfame/pictures/";
	...
	if ($result != "Your file has been successfully uploaded to the server."){
		...
		$upload_class->hof_uploadform($_POST['path'],$_POST['status']);
		...
		imagejpeg($dst_img, $upload_class->upload_dir.$file);
	...
	if (isset($_GET['id'])){
		$upload_class->hof_uploadform($_GET['id']);
	}else{
